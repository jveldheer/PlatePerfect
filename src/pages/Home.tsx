        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <Link to="/skills" className="card p-4 sm:p-6 hover:scale-[1.02] md:hover:scale-105 transition-transform">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold mb-2">Learn Cooking Skills</h3>
          ...
          <Link to="/recipes" className="card p-4 sm:p-6 hover:scale-[1.02] md:hover:scale-105 transition-transform">
            <div className="flex items-start">
              <div className="text-3xl sm:text-4xl mr-3 sm:mr-4">🍳</div>
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold mb-2">Explore Recipes</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
      ...
      <section className="text-center px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto">
          <div className="bg-white rounded-lg p-3 sm:p-4 shadow">
            <p className="text-xl sm:text-2xl font-bold text-primary-600 mb-1">Protein</p>
            <p className="text-xs sm:text-sm text-gray-600">For muscle repair</p>
          </div>
          <div className="bg-white rounded-lg p-3 sm:p-4 shadow">
            <p className="text-xl sm:text-2xl font-bold text-primary-600 mb-1">Carbs</p>
            <p className="text-xs sm:text-sm text-gray-600">For energy fuel</p>
          </div>
          <div className="bg-white rounded-lg p-3 sm:p-4 shadow">
            <p className="text-xl sm:text-2xl font-bold text-primary-600 mb-1">Timing</p>
            <p className="text-xs sm:text-sm text-gray-600">Pre/post workout</p>
          </div>
          <div className="bg-white rounded-lg p-3 sm:p-4 shadow">
            <p className="text-xl sm:text-2xl font-bold text-primary-600 mb-1">Portions</p>
            <p className="text-xs sm:text-sm text-gray-600">Proper serving sizes</p>
          </div>
        </div>
      </section>
    </div>
